// ============================================================================
// takshaka_pkg.sv — Shared types, opcodes & CSR constants for Takshaka.
//
// Takshaka is a compact, high-performance 3-stage in-order RV32IMAC core.
// This package holds the datapath types used across the core and its leaf cells.
// ============================================================================
`ifndef TAKSHAKA_PKG_SV
`define TAKSHAKA_PKG_SV

package takshaka_pkg;
