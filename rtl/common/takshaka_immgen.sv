// ============================================================================
// takshaka_immgen.sv — RISC-V immediate generator (shared leaf cell).
// Extracts the five immediate formats from a 32-bit instruction. Purely
// combinational; reused by every Takshaka core so the sign-extension logic lives
// in exactly one place.
// ============================================================================
`include "takshaka_pkg.sv"

module takshaka_immgen
  import takshaka_pkg::*;
(
