// ============================================================================
// takshaka_decode.sv — base RV32IM(C) instruction decoder (shared leaf cell).
//
...
// source of truth previously duplicated inline in every core; the Takshaka core instantiates it (extensions may wrap it
// decode). Behaviour is byte-identical to the original inline decoders.
// ============================================================================
`include "takshaka_pkg.sv"

module takshaka_decode
  import takshaka_pkg::*;
(
