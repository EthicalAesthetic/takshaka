/* ==========================================================================
 * main.c -- Takshaka FreeRTOS demo.
 *
 * Proves a REAL preemptive RTOS running on the Takshaka core:
 ...
 *
 * All console output goes through the Takshaka UART; the sim captures it. The
