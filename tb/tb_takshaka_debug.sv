// ============================================================================
// tb_takshaka_debug.sv — self-checking JTAG / RISC-V Debug-Module testbench for
// the 3-stage Takshaka core (pipelined drain-to-halt). Bit-bangs the JTAG TAP:
//   1. IDCODE ("TAKS")   2. dmactive+haltreq → allhalted
...
module tb_takshaka_debug;
  ...
  initial begin
    ...
    check("idcode", idcode, 32'h5441_4B53);
