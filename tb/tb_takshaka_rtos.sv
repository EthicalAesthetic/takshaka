// ============================================================================
// tb_takshaka_rtos.sv — RTOS bring-up harness for takshaka_soc.
//
//   vvp sim/tb_takshaka_rtos +IMEM=rtos/build/rtos.hex     [+MAXCYC=<n>]
//
// Runs a FreeRTOS image on the Takshaka SoC. The SoC UART $writes every TX
