// ============================================================================
// tb_takshaka_priv.sv — directed M/U + PMP testbench for Takshaka SECURE=1.
//
//   vvp sim/tb_takshaka_priv +IMEM=programs/build/priv_<name>.hex
//
// Instantiates takshaka_core with SECURE(1) directly (no SoC), with a simple
...
module tb_takshaka_priv;
  ...
  takshaka_core #(.SECURE(1'b1)) u_core (
    .clk(clk), .rst(rst),
