...
The reference SoC (`rtl/takshaka_soc.sv`) wires the core to instruction and data
...
| **UART** | character-output console peripheral |
...
in `takshaka_soc.sv` and can be relocated to suit your address plan.
